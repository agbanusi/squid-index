...
export const functions = {
    ...
    safeBatchTransferFrom: new Func<[from: string, to: string, ids: Array<bigint>, values: Array<bigint>, data: string], {from: string, to: string, ids: Array<bigint>, data: string}, []>(
        abi, '0x2eb2c2d6'
    ),
    safeTransferFrom: new Func<[from: string, to: string, id: bigint, value: bigint, data: string], {from: string, to: string, id: bigint, value: bigint, data: string}, []>(
        abi, '0xf242432a'
    ),
